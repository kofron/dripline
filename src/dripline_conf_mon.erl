%% @doc dripline_conf_mon is one of the dripline 'monitor' modules.
%%		it watches the dripline_conf database on a couchdb server for
...
%%		a specific revision, which it will ignore.  dripline_conf_mon
%%		is responsible for streaming configuration changes to the 
%%		dripline system.
...
%%		telling couchdb it wants streaming changes from the dripline_conf
%%		database.
%% @end
%%---------------------------------------------------------------------%%
